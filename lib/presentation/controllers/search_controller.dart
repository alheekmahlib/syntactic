...
//     if (bookCtrl.state.loadedPoems.isEmpty || query.isEmpty) {
//       searchResults.clear();
//       return;
//     }
//
...
//     for (final poemBook in bookCtrl.state.loadedPoems) {
//       tempSearchResults
...
//       }).toList());
//     }
//     // for (final poemBook in bookCtrl.state.poemBooks) {
//     // poemBook.parts.asMap().forEach((chapterIndex, chapter) {
