...
class PoemsReadView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final chapter = bookCtrl
        .state.booksList[bookCtrl.state.bookNumber.value].parts.first.chapters;
    final bookName =
        bookCtrl.state.booksList[bookCtrl.state.bookNumber.value].bookName;
                      ...
                      itemBuilder: (context, chapterIndex) {
                        WidgetsBinding.instance.addPostFrameCallback((_) {
                          bookCtrl.saveLastRead(
                            ...
                            bookCtrl
                                .state
                                .booksList[bookCtrl.state.bookNumber.value]
                                .bookName,
                            bookCtrl
                                .state
                                .booksList[bookCtrl.state.bookNumber.value]
